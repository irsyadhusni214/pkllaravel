                    ...
                    <div class="card-body">
                        <form action="{{ route('kasus2.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="1" name="positif" class="form-control" id=""
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="1" name="sembuh" class="form-control" id="">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="1" name="meninggal" class="form-control" id="">
